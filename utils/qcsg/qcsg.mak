...
# ADD LINK32 opengl32.lib glu32.lib glaux.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib uuid.lib /nologo /subsystem:console /machine:I386 /out:"../../tools/qcsg.exe"
...
"..\..\tools\qcsg.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
"$(INTDIR)\hullfile.obj" : $(SOURCE) $(DEP_CPP_HULLF) "$(INTDIR)"
...
"$(INTDIR)\hullfile.sbr" : $(SOURCE) $(DEP_CPP_HULLF) "$(INTDIR)"
